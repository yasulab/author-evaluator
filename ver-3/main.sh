...
then
    ...
    python ./simple-tag-getter/tag-getter-without-lxml.py http://twitter.com/$1 span class=entry-content > ./log/tweets-by-$1.txt
    printf "Done.\n"
    ...
    python ./simple-tag-getter/tag-getter-without-lxml.py http://twitter.com/$2/$3 span class=entry-content > ./log/$2-$3-list.txt
    printf "Done.\n"
